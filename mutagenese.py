...
class Mutagenese(Experiment):
    def __init__(self, config: ConfigParser):
        ...
        self.mutation_types = [MUTATIONS[mutation_type] for mutation_type in self.mutation_names]
    ...
    def prepare_mutagenese(self, value: int) -> Genome:
        if self.variable == "g":
            g = value
        else:
    ...
    def plot_mutagenese(self):
        ...
        for mutation_type in self.mutation_names:
            ...
            graphics.plot_mutagenese(x_value, neutral_proportions, neutral_stds, save_dir, f"Neutral {mutation_type.lower()} proportion", 
                                     self.variable, theoretical_proportions)
